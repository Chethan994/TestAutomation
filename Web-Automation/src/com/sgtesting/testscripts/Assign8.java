...
public class Assign8 {
	...
	static void createproject()
	{
		...
		
		{
			...
			Thread.sleep(4000);
			oBrowser.findElement(By.xpath("//*[@id=\'projectPopup_projectNameField\']")).sendKeys("kaveri project");
			Thread.sleep(4000);
	...
	static void createtask()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath("//*[@id=\'createTasksPopup_createTasksTableContainer\']/table/tbody/tr[1]/td[1]/input")).sendKeys("chitradurga");
			Thread.sleep(3000);
	...
	static void modifytask()
	{
		...
		Thread.sleep(2000);
		oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[2]/div[1]/div[2]/div[3]/div[2]/div/div[1]/textarea")).sendKeys("jain institute");
		Thread.sleep(2000);
